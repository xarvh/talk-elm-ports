...
var _xarvh$elm_slides$Main$main = A2(
	...
	_xarvh$elm_slides$Slides$slidesDefaultOptions,
	{
		...
		_1: {
			...
			_0: _xarvh$elm_slides$Slides$mdFragments(
				{
					ctor: '::',
					_0: 'Everything inside Elm code is pure, separated from the outside world:',
					_1: {
						ctor: '::',
						_0: '![Elm vs JS](none.png)',
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _xarvh$elm_slides$Main$main !== 'undefined') {
    _xarvh$elm_slides$Main$main(Elm['Main'], 'Main', undefined);
}
